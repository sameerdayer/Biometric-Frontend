                ...
                <div className="sub-container">
                  <div className="in-sub-container">
                    <div className="sub-page-heading">
                      <Link className="in-sub-page-heading" to="/year-1">
                  ...
                  <div className="in-sub-container">
                    <div className="sub-page-heading">
                      <Link className="in-sub-page-heading" to="/year-2">
                        <div className="mini-nav-icons">
                          <GoHome className="mini-nav-icon" />
                        </div>
                        <div className="sub-n-title">
                  ...
                  <div className="in-sub-container">
                    <div className="sub-page-heading">
                      <Link className="in-sub-page-heading" to="/year-3">
                        <div className="mini-nav-icons">
                          <GoHome className="mini-nav-icon" />
                        </div>
                        <div className="sub-n-title">
                  ...
                  <div className="in-sub-container">
                    <div className="sub-page-heading">
                      <Link className="in-sub-page-heading" to="/year-4">
                        <div className="mini-nav-icons">
                          <GoHome className="mini-nav-icon" />
                        </div>
                        <div className="sub-n-title">
